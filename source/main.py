...
def main():
    ...
    init_traders[blocks, threads_per_block](True, rng_states, d_black, shape, 1.0)
    init_traders[blocks, threads_per_block](False, rng_states, d_white, shape, 1.0)
    ...
    flips_per_ns = total_updates * (grid_width * grid_height) / (elapsed_time.seconds * 1e9 + elapsed_time.microseconds * 1e3)
